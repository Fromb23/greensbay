		  ...
		  <form className="flex flex-col space-y-4 h-auto">
			<div className="flex flex-col sm:gap-4">
				<div className="flex sm:w-full sm:flex-row sm:w-1/2 gap-8 flex-1">
					<input type="text" placeholder="First Name" className="h-12 sm:w-1/2 my-4 border rounded" />
					<input type="text" placeholder="Last Name" className="sm:w-1/2 my-4 border rounded" />
				</div>
